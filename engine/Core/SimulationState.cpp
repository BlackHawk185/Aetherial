...
void SimulationState::createDefaultWorld()
{
    ...
    struct WorldGenConfig {
        uint32_t worldSeed;
        float regionSize = 2400.0f;
        float voronoiCellSizeMin = 1600.0f;   // Min Voronoi cell size (determines spacing & island size)
        float voronoiCellSizeMax = 1600.0f;  // Max Voronoi cell size (variation in spacing & size)
